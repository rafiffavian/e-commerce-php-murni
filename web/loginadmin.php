			...
			<div class="account-main">
				<div class="col-md-6 account-left">
					...
					<div class="account-bottom">
						<form action="loginadmin_proses.php" method="post">
							<input placeholder="Email" name="user" type="text" tabindex="3" required>
				...
				<div class="col-md-6 account-right account-left">
					...
					<a href="registeradmin.php">Create an Account</a>
				</div>
				<div class="clearfix"></div>
			</div>
		</div>

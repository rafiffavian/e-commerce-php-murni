		...
		<div class="container">
			...
			<div class="register-main">
				<div class="col-md-6 account-left">
					<form action="registeradmin_proses.php" method="post">
						...
						<input placeholder="Username" name="user" type="text" tabindex="3" required>
						...
						<ul>
							...
							<div class="col-md-6 account-left">
								...
								<input placeholder="Retype password" name="rpassword" type="password" tabindex="4" required><br><br>
								<label>PILIH STATUS ADMIN</label>
								<select name="hak" class="form-control" style="width: 490px; border-color: black"  required>
					...
					<?php 
						if (isset($_GET['d'])) {
							echo "<h4>PERIKSA DATA DENGAN BENAR, MUNGKIN PASSWORD DAN RETYPE PASSWORD TIDAK SAMA!!!</h4>";
						}
					 ?>

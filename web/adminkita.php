			...
			<div class="in-check" >
				<ul class="unit">
					...
					<?php 
						...
						$sql = "SELECT * FROM `transaksi`,`pembeli` WHERE `transaksi`.`id_pembeli` = `pembeli`.`id_pembeli` ORDER BY `waktu` desc";
				...
				<ul class='cart-header'>
									...
									<li><span class='name'>$v[first_name]</span></li>
									<li><span class='cost'>Rp ". number_format($v['total']) . "	
									<li><span class='name'>$v[waktu]</span></li>
									<li><span class='name'>$v[status_pengiriman]</span></li>
									<a href='admin_detail.php?id=$v[id_transaksi]' class='btn btn-warning'>DETAIL</a></span></li>

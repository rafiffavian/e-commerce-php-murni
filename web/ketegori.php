	...
	<div class="ckeckout">
		<div class="container">
			...
			<script>$(document).ready(function(c) {
			   ...
			   <?php
			   		if(isset($_GET['id'])){
			   			$id = $_GET['id'];
			   			$h1 = "EDIT";
			   			$a = $dbh->query("SELECT * FROM `kategori` WHERE `id_kategori` = '$_GET[id]'")->fetch();
			   			$cls = "btn btn-info";
			   		}
			   		else{
			   			$id="";
			     ...
			     ?>
			     <h3 style="text-align: center;"><?php echo $h1;?> Kategori</h3><br><br>

			   <div class="row">
					<div class="col-sm-4 col-sm-offset-4">
					   <form method="post" action="ketegori_proses.php">	
					   		<input type="text" name="kategori" value="<?php echo $a['nama_kategori'] ?>" placeholder="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tambah Kategori" class="form-control"><br><br>
					   		<input type="submit" name="proses" class="<?php echo $cls ?> form-control" value="<?php echo $h1 ?>">
			...
			<div class="in-check7" >
				...
				<ul class='cart-header7'>

										<li><span class='name'>$no</span></li>
										<li><span class='name'>$v[nama_kategori]</span></li>
										<li><span class='name'>
											<a href = 'ketegori.php?id=$v[id_kategori]' class = 'btn btn-info'>EDIT</a>
											<a href = 'ketegori_proses.php?id=$v[id_kategori]' class = 'btn btn-danger'>HAPUS</a>
										</span></li>
